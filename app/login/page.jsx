                        ...
                        <form action="">
                            <div className="">
                                ...
                                <div className="mb-3">
                                    ...
                                    <p className="mt-2 text-sm text-red-400">영문, 숫자를 포함한 8자 이상의 비밀번호를 입력해주세요.</p>
                                </div>
                                {/* 자동 로그인 체크박스 */}
                            ...
                            {/* 로그인 */}
                            <button className="block w-full p-3 font-bold font-md text-white bg-[#4e5968]  rounded-lg mt-10">로그인</button>
                            ...
                            <div>
                                <Link href="/login/password" className="block mx-auto mt-10 text-sm font-semibold leading-6 text-center text-gray-600 underline-link w-fit">
                                    비밀번호를 잊으셨나요?
                                </Link>

                                <div className="flex justify-center mt-5 item-center">
                                    <p className="font-semibold pr-1.5 text-gray-400 text-sm">계정이 없으신가요?</p>
                                    <Link href="/login/password" className="text-sm font-semibold text-gray-600 underline-link">
                                        가입하기
                                    </Link>
                                </div>
                            </div>
