        ...
        <>
            <section className="header">
                <nav className="navbar">
                    <div className={`container--default ${isNavbarActive ? "navbar--active" : ""}`}>
                        <div className="flex justify-between container__inner">
                            <div className="flex items-center mr-6 min-h-[3.75rem]">
                                <Link href="/" className="w-15">
                                    <span className="w-auto h-auto ">
                                        <svg className="w-auto h-5" width="43" height="17" viewBox="0 0 44 18">
                            ...
                            <div className="navbar__content--bottom md:navbar__content">
                                <ul className="navbar__menu">
                                    <li className={`navbar__item ${currPath === "/" ? "on" : ""}`}>
                                        <Link className="gfont" href="/">
                                            <span>
                                                <svg className="color--gray" width="19" height="21" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li className={`navbar__item ${currPath === "/room-reservation" ? "on" : ""}`}>
                                        <Link className="gfont" href="/room-reservation">
                                            <span>
                                                <svg className="color--gray" width="21" height="22" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li className={`navbar__item ${currPath === "/booking-history" ? "on" : ""}`}>
                                        <Link className="gfont" href="/booking-history">
                                            <svg className="color--gray" width="22" height="24" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex items-center ml-6 min-h-[3.75rem]">
                                <Link href="/my-page">
                                    <span className="profile__box">
                                        <svg className="profile__icon" width="16" height="16" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
