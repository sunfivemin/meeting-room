                                ...
                                <form className="max-w-[100%] mr-auto gap-4 overflow-y-auto">
                                    <div className="gap-2 flex__col">
                                        ...
                                        <div className="flex items-center w-full mb-10 ">
                                            <input type="text" placeholder="회의명을 입력하세요" className="flex-1 py-2 placeholder-gray-300 border-b border-gray-300 outline-none hover:border-[#5C92FF] focus:border-[#5C92FF]"></input>
                                        </div>
                                    </div>
                                    ...
                                    {/* 개설자 드롭다운 */}
                                    <div className="gap-2 mb-10 flex__col">
                                        <label className="font-bold text-md text-navy-700">개최자</label>
                                        <ComboBox />
                                    </div>

                                    {/* 참여자 드롭다운 */}
                                    <div className="gap-2 mb-10 flex__col">
                                        <label className="font-bold text-md text-navy-700">참여자</label>
                                        <ComboBox />
                                    </div>
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <div className="mt-1">
                                            <textarea
                                                ...
                                                className="items-center justify-center flex-1 w-full p-3 mt-2 border border-gray-300 rounded-lg outline-none h-55 text-md bg-white/0 focus:border-indigo-400"></textarea>
                                        </div>
                                    </div>

                                    <div className="flex justify-center gap-4">
                                        <button type="submit" className="bg-[#5C92FF] hover:bg-[#3541a7] text-white py-2 px-4 rounded">
                                            예약하기
                                        </button>
